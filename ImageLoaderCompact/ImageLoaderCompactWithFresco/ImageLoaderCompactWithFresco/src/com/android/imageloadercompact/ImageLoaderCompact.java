...
import com.android.imageloadercompact.fresco.Packet;
import com.android.imageloadercompact.fresco.PacketCollector;
...
public class ImageLoaderCompact implements CompactImpl {
    ...
    public void onStart(Context ctx) {
        Fresco.initialize(ctx, getDefaultImagePipelineConfig(ctx));
    }
    ...
    @Override
    public void asyncFetchBitmapByUrl(Context ctx, final String url,
