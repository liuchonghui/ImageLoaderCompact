...
//        okHttpClient = new OkHttpClient();
    ...
    public void onStart() {
        Fresco.initialize(ImageLoaderCompact.getInstance().getApplicationContext(),
                getDefaultImagePipelineConfig(ImageLoaderCompact.getInstance().getApplicationContext()));
    }
    ...
    public ImagePipelineConfig getImagePipelineConfig() {
        if (config == null) {
            config = getDefaultImagePipelineConfig(
